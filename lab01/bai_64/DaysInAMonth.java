//Exercises: 6.4 DaysInAMonth.java
...
public class DaysInAMonth {
	public static void main(String[] args) {
		...
		while (true) {
			...
			scanner.nextLine();
			if(year < 0) {
				System.out.println("The year you entered is invalid you. Please enter another year");
				continue;
			}
            break;
        }
        ...
        while (true) {
			...
			if (monthInput.equals("January") || monthInput.equals("Jan.") || 
            	...
            	System.out.println("The month you entered is invalid. Please enter another month");
            	continue;
            }
